...
], validate_1.validate, cartController.addToCart);
// Update cart item quantity
router.put('/items/:itemId', [
    (0, express_validator_1.param)('itemId').isUUID(),
    (0, express_validator_1.body)('quantity').isInt({ min: 1 }).withMessage('Quantity must be at least 1')
], validate_1.validate, cartController.updateCartItem);
// Remove item from cart
router.delete('/items/:itemId', [(0, express_validator_1.param)('itemId').isUUID()], validate_1.validate, cartController.removeFromCart);
// Clear cart
