...
class DatabaseOptimization {
    ...
    static async optimizeIndexes() {
        ...
        try {
            ...
            for (const check of indexChecks) {
                ...
                logger_1.logger.info(`Checking index for ${check.table}.${check.field}`);
            }
            optimizations.push('Index optimization completed');
        }
        catch (error) {
            logger_1.logger.error('Index optimization failed:', error);
            throw error;
        }
    ...
    static async optimizeConnections() {
        try {
            ...
            logger_1.logger.error('Connection optimization failed:', error);
            throw error;
        }
    }
    /**
    ...
    static async cleanupOldData(daysToKeep = 90) {
        ...
        try {
            ...
            logger_1.logger.info('Database cleanup completed:', deletedRecords);
    ...
    static async vacuumAnalyze() {
        try {
            ...
            logger_1.logger.info('Running VACUUM ANALYZE on all tables');
            // In a real implementation:
            // await prisma.$executeRaw`VACUUM ANALYZE`;
            logger_1.logger.info('VACUUM ANALYZE completed');
        }
        catch (error) {
            logger_1.logger.error('VACUUM ANALYZE failed:', error);
            throw error;
        }
    }
    /**
